...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4>Daftar Aduan Kebakaran</h4>
    </div>

    <div class="card">
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover" id="tabelAduan">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Tanggal</th>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <p><strong>No. Telepon:</strong> <?= esc($item['telepon']) ?></p>
                                        <p><strong>Lokasi:</strong> <?= esc($item['lokasi']) ?></p>
                                        <p><strong>Deskripsi:</strong> <?= esc($item['deskripsi']) ?></p>
                                        <p><strong>Status:</strong> <?= $item['status'] ?></p>
                                        <p><strong>Keterangan:</strong> <?= esc($item['keterangan'] ?? '-') ?></p>
                        ...
                        <div class="modal fade" id="updateModal<?= $item['id'] ?>" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form onsubmit="return updateStatus(this, <?= $item['id'] ?>)">
                                        <div class="modal-body">
                                            <div class="mb-3">
...
<script>
function updateStatus(form, id) {
    const formData = new FormData(form);
    formData.append('id', id);

    fetch('<?= base_url('admin/aduan/updateStatus') ?>', {
        method: 'POST',
        body: formData
    })
